...
#ifdef DEBUG_EN
#define DEBUGF(format, ...) ay_debug_printf(AYE_LOG_LEVEL_DEBUG, __FILE__, __LINE__, format, ##__VA_ARGS__)
#define TRACEF(format, ...) ay_debug_printf(AYE_LOG_LEVEL_TRACE, __FILE__, __LINE__, format, ##__VA_ARGS__)
#define ERRORF(format, ...) ay_debug_printf(AYE_LOG_LEVEL_ERROR, __FILE__, __LINE__, format, ##__VA_ARGS__)
#else
#define DEBUGF   infof
