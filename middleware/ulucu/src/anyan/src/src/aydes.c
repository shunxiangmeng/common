...
int DES_Encrypt(unsigned char *pPlainData, int iPlainDataLength, unsigned char *pKeyStr, int iKeyLength, unsigned char *pCipherData, int iCipherMaxSize, int* piCipherSize)
{
	int count;
	...
	{
		DEBUGF("not enough size of encrypt!\n");
		return -1;
	}
