...
#else
extern DWORD RandBetween(DWORD dwLower,DWORD dwUpper,DHCryptData *pData);
extern int BNSquare(DWORD w[], const DWORD x[], UINT nSize);
#endif
...
#else
extern DWORD BNShiftLeft(DWORD a[], const DWORD *b, UINT x, UINT nSize);
#endif
