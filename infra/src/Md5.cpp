...
static unsigned char s_PADDING[] = {
...
void MD5Final(MD5_CTX *context, unsigned char digest[16]) {
    ...
    MD5Update(context, s_PADDING, padlen);
...
void MD5Sum(const char* in, int in_len, char* out) {
